...
public class Game {
    ...
    public boolean winner(ArrayList<mButton> bord, String playerSymbole) {
        for (int i =0;i<=2;i++) {
            if (
    ...
    public ChicArray minimax(ArrayList<mButton> bord , String player,int depth) {
    ...
    public mButton update(ArrayList<mButton> currentBord ) {
    ...
    public static class mButton{
        ...
        public static ArrayList<mButton> fromJButtonsList(ArrayList<JButton> buttons){
